...
describe("clientUtil", function () {
  ...
  describe("#getDir()", function () {
    it("should return the directory path of the file path", function () {
      const result = clientUtil.getDir(
        "C:\\Users\\user\\Documents\\example.html"
      );
    ...
    it("folder 1", function () {
      const result = clientUtil.getDir("C:\\Users\\user\\Documents");
      assert.strictEqual(result, "C:\\Users\\user");
    });

    it("folder 2", function () {
      const result = clientUtil.getDir("C:\\Users\\user\\Documents\\");
      assert.strictEqual(result, "C:\\Users\\user");
    });
  });
  ...
  describe("#getBaseName()", function () {
    ...
    it("should return the base name of the file path 2", function () {
      const result = clientUtil.getBaseName("C:\\Users\\user\\Documents\\");
      assert.strictEqual(result, "Documents");
    });

    it("should return the base name of the file path 3", function () {
      const result = clientUtil.getBaseName("C:\\Users\\user\\Documents\\");
      assert.strictEqual(result, "Documents");
    });
