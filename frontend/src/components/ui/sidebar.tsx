    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "sidebar-wrapper has-data-[variant=inset]:bg-sidebar",
            className,
          )}
          {...props}
        >
...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="sidebar-main w-(--sidebar-width)"
          style={
            {
  ...
  return (
    <div
      className="sidebar-container group peer hidden md:block"
      data-state={state}
    ...
    >
      ...
      <div
        ...
        data-variant={variant}
        data-side={side}
        className={cn("sidebar-gap", className)}
      />
      <div
      ...
      >
        <div
          ...
          className="sidebar-inner flex h-full w-full flex-col"
        >
          {children}
        </div>
      </div>
